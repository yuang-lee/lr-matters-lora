...
train_bs=(16 128)      # Training batch size
tasks=("metamath") # Task to fine-tune.
...
peft_methods=("LoRA" "PiSSA" "MiLoRA" "InitAB" "DoRA") # assign the PEFT methods you would like to run
