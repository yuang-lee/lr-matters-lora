'''
Reference: https://github.com/sufenlp/MiLoRA/blob/main/svd_init.py
'''
...
def svd_tailor_and_save(args):
    ...
    # move_lora_file(args.output_dir)
...
parser.add_argument("--bits", type=str, default="bf16", choices=["bf16", "fp16", "fp32"]) ## will there be issue if we also set pretrained model weights to bf16 for getting minor spectral components?
